...
export declare class AuthQuerier {
    ...
    accounts(request: import("../protobuf_stuff/cosmos/auth/v1beta1/query").QueryAccountsRequest, metadata?: grpc.Metadata): Promise<Account[]>;
    /** returns account details based on address. */
    account({ address, }: import("../protobuf_stuff/cosmos/auth/v1beta1/query").QueryAccountRequest, metadata?: grpc.Metadata): Promise<Account>;
    /** queries all parameters. */
    params(metadata?: grpc.Metadata): Promise<import("../protobuf_stuff/cosmos/auth/v1beta1/query").QueryParamsResponse>;
}
export {};
