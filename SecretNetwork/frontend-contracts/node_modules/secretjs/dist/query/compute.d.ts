...
export declare class ComputeQuerier {
    ...
    contractCodeHash(address: string, metadata?: grpc.Metadata): Promise<string>;
    /** Get codeHash from a code id */
    codeHash(codeId: number, metadata?: grpc.Metadata): Promise<string>;
    /** Get metadata of a Secret Contract */
    contractInfo(address: string, metadata?: grpc.Metadata): Promise<QueryContractInfoResponse>;
    /** Get all contracts that were instantiated from a code id */
    contractsByCode(codeId: number, metadata?: grpc.Metadata): Promise<QueryContractsByCodeResponse>;
    /** Query a Secret Contract */
    queryContract<T extends object, R extends object>({ contractAddress, codeHash, query }: QueryContractRequest<T>, metadata?: grpc.Metadata): Promise<R>;
    /** Get WASM bytecode and metadata for a code id */
    code(codeId: number, metadata?: grpc.Metadata): Promise<QueryCodeResponse>;
    codes(metadata?: grpc.Metadata): Promise<CodeInfoResponse[]>;
}
