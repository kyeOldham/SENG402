...
export declare class ContractTxResponseHandler<T> implements ContractMessageResponse<T> {
    ...
    isEmpty(): boolean;
    static of<T>(response: ExecuteResult | TxsResponse): ContractMessageResponse<T>;
}
export declare function createContract<T>(contract: ContractSpecification): T;
export declare function createContractClient<T>(contract: ContractSpecification): T;
...
export declare function executeMultiMessage<R>(infos: MultiMessageInfo[], memo?: string): Promise<ContractMessageResponse<R>>;
export declare function buildMessage(contract: BaseContract, message: MessageGetter, ...args: unknown[]): MultiMessageInfo;
