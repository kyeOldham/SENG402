...
class ComputeQuerier {
    ...
    contractCodeHash(address, metadata) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.init();
            let codeHash = this.codeHashCache.get(address);
            if (!codeHash) {
                const { ContractInfo } = yield this.contractInfo(address, metadata);
                codeHash = (yield this.codeHash(Number(ContractInfo.codeId), metadata))
                    .replace("0x", "")
                    .toLowerCase();
    ...
    codeHash(codeId, metadata) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.init();
            let codeHash = this.codeHashCache.get(codeId);
            if (!codeHash) {
                const { codeInfo } = yield this.code(codeId, metadata);
    ...
    contractsByCode(codeId, metadata) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.init();
    ...
    queryContract({ contractAddress, codeHash, query }, metadata) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.init();
            if (!codeHash) {
    ...
    code(codeId, metadata) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.init();
            const response = yield this.client.code({ codeId: String(codeId) }, metadata);
    ...
    codes(metadata) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.init();
            const response = yield this.client.codes({}, metadata);
