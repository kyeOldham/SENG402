...
class AuthQuerier {
    ...
    accounts(request, metadata) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.init();
            const response = yield this.client.accounts(request, metadata);
    ...
    account({ address, }, metadata) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.init();
            const response = yield this.client.account({ address }, metadata);
    ...
    params(metadata) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.init();
            return yield this.client.params({}, metadata);
        });
    }
}
